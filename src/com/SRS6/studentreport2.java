...
public class studentreport2 extends Activity  {
	int[]  strquizno;
	String[] strquizname; 
	DataBaseHelper data;
	EditText s;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.studentreport2);
...
/*Type :Function
		...
		return type:void
		date:29-6-11
		purpose:Retrieves name score and date from server and Inserts tests to local database*/
    ...
    /*Type :Function
		...
		return type:void
		date:29-6-11
		purpose:Inserts final result to database server*/
...
/*Type :Function
	...
	/*Type :Function
		...
		return type:void
		date:29-6-11
		purpose:Retrieve test name from local database*/
